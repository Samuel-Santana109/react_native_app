            ...
            <View style={{ flex: 1 }}>
              ...
              >
                <View style={styles.categoryContent}>
                  <Image source={{ uri: `${BASE_URL}/${encodeURI(item.image)}` }} style={styles.categoryImage} />
          ...
          {nextCategory && (
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                >
                  <View style={styles.categoryContent}>
                    <Image source={{ uri: `${BASE_URL}/${encodeURI(nextCategory.image)}` }} style={styles.categoryImage} />
